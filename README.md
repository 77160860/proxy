sing脚本基于**Sing-box**内核的多协议一键安装脚本，支持Hysteria2、Tuic v5、Snell v5、VLESS-Reality、SS2022-shadowtls、Trojan-WS协议，并集成了Cloudflare Argo隧道功能搭配Trojan使用，支持单协议及全协议一键安装。
...
*   `st`: 设置 SS2022-shadowtls 端口 (如 `st=20005`不设置则随机生成)
